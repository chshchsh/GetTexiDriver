...
public class CurentLocation extends Activity {
    ...
    private void getLocation() {
        ...
        try {
            ...
            locationOff = Settings.Secure.getInt(this.getContentResolver(), Settings.Secure.LOCATION_MODE);
